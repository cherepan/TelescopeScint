...
void plot0(){
  ...
  string file_1 = "Counts_SCINT0_NoSource_15s.dat";  string file_2 = "Counts_SCINT0_SrSource_15s.dat";
  ...
  gr1->SetTitle("Threshold scan, SCINT0, PMT V = 883 mV ");
  ...
  gr3->SetTitle("Threshold scan, SCINT0, PMT V = 883 mV ");
