...
void plot3(){
  ...
  string file_1 = "Counts_SCINT3_NoSource_15s.dat";  string file_2 = "Counts_SCINT3_SrSource_15s.dat";
  ...
  gr1->SetTitle("Threshold scan, SCINT3, PMT V = 885 mV ");
  ...
  gr3->SetTitle("Threshold scan, SCINT3, PMT V = 885 mV ");
